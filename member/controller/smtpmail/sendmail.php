...
if(isset($_POST["send"])){
	...
	$mail->Username = "kingpauloaquino@mail.com"; //Username for SMTP authentication any valid email created in your domain
	$mail->Password = "kpa098765"; //Password for SMTP authentication
	$mail->AddReplyTo("reply@yourdomain.com", "Reply name"); //reply-to address
	$mail->SetFrom("kingpauloaquino@yourdomain.com", "Asif18 SMTP Mailer"); //From address of the mail
