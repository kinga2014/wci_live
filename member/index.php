<?php 
	...
	$profiles = $Queries->Fetch_Array( $profile, FALSE, FALSE );
...
<head>
	...
	<script src="../assets/js/ptxt-jQueries.js"></script>
	<script src="../assets/js/DateTime.js"></script>

</head>
<body onload="dtLocal('dtLocal');">
    ...
    <div class="navbar-header pull-left">
        <div class="navbar-brand">
            ...
            <a href="../member/" class="appbrand innerL">
    ...
    <ul class="nav navbar-nav navbar-right hidden-xs">
    	 <li><a href="?p=post-ads" style="background-color: #1fa2e4; color: #fff;">Post Free Ads</a></li>
	        ...
	        <li class=" hidden-xs">
	            <form class="navbar-form navbar-left " role="search">
	                <div class="input-group">
	                    ...
	                    <input type="hidden" id="dtLocal" name="dtLocal" />
        ...
        <li class="dropdown">
            ...
            <ul class="dropdown-menu list pull-right ">
                ...
                <li><a href="?p=logout">Log out <i class="fa fa-sign-out pull-right"></i></a></li>
            </ul>
        </li>
        <li><a href="?p=logout" class="menu-icon"><i class="fa fa-sign-out"></i></a></li>
    </ul>
</div>
...
<div id="menu" class="hidden-print hidden-xs">
	<div class="sidebar sidebar-inverse">
		<div class="user-profile media innerAll">
			...
			<div class="media-body">
				<a href="?profile=<?php echo $profiles[ "username" ]; ?>" class="strong"> <?php $fullname = $profiles[ "firstname" ] . " " . $profiles[ "lastname" ]; echo  $Function->Sentence_Cap(" ", $fullname); ?> </a>
		...
		<div class="sidebarMenuWrapper">
			<ul class="list-unstyled">
				<li class='active'><a href="../member"><i class=" icon-projector-screen-line"></i><span>Dashboard</span></a></li>
				<li class="hasSubmenu">
					...
					<ul class="collapse" id="menu-style-Advertisement">
						<li><a href="?p=manage-ads"><i class="icon-compose"></i><span>Manage Ads</a></li>
						<li><a href="?p=free-ads"><i class="icon-group"></i><span>Free Ads</a></li>
						<li><a href="?p=premium-ads"><i class="icon-group"></i><span>Premium Ads</a></li>
						<li><a href="?p=active-ads"><i class="icon-group"></i><span>Active Ads</a></li>
					</ul>
				</li>
				...
				<li class="hasSubmenu">
					...
					<ul class="collapse" id="menu-style-Messaging">
						<li><a href="?p=add-member"><i class="icon-compose"></i><span>Write</a></li>
						<li><a href="?p=admin/member-list"><i class="icon-group"></i><span>Inbox</a></li>
						<li><a href="?p=admin/member-list"><i class="icon-group"></i><span>Sent Items</a></li>
					</ul>
				</li>
				...
				<li class="hasSubmenu">
					...
					<ul class="collapse" id="collapse-menu-Premium">
						<li><a href="?p=admin/balance"><i class="icon-bulleted-list"></i><span>Available</span></a></li>
						<li><a href="?p=admin/buy-credits"><i class="icon-ticket"></i><span>Buy Premium Credits</span></a></li>
						<li><a href="?p=admin/transfer-credits"><i class="icon-compose"></i><span>Transfer Premium Credits</span></a></li>
						<li><a href="?p=admin/transaction-history"><i class="icon-folder-add"></i><span>Transaction History</span></a></li>
					</ul>
				</li>
	...
	<?php
		switch ($pageSelected) {
			case 'manage-ads':
				include 'view/manage-ads.php';
				break;
			case 'view-ads':
				include 'view/view-ads.php';
				break;
			case 'post-ads':
				include 'view/view-ads.php';
				break;
